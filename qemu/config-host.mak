...
libs_softmmu=-lpixman-1 -lutil -Wl,-Bsymbolic-functions -lncurses -ltinfo  -luuid -lpng16 -lz -lSDL -lX11  
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.3.0
PKGVERSION=
SRC_PATH=/home/neo/Code/projects/6.828/qemu
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/neo/Code/projects/6.828/qemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
